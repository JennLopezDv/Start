Sistema Integral de Gestión de Inventario y Ventas con Reportes Dinámicos Caso de uso (Épica): 
Como encargado del área digital de una librería nacional, necesitas un sistema robusto que no solo permita registrar ventas y productos, 
sino también generar reportes detallados, aplicar descuentos por cliente, agrupar estadísticas por autor y evaluar el rendimiento del inventario con base en ventas. 
...
6. Almacenamiento en estructuras de datos:
  ...
  • Agrupaciones y búsquedas deben usar métodos y estructuras eficientes. Criterios de Aceptación
